...
export default function VocabularyPracticePage() {
  ...
  React.useEffect(() => {
    async function load() {
      const q = await exerciseService.getQuestionsByCategory("academic", 20, 0);
        ...
        <Card className="text-center p-8 sm:p-12 space-y-6 border-indigo-100 dark:border-indigo-950 shadow-elevated bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-950">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-md mx-auto">
              Accuracy: <strong>{score.accuracyPercent}%</strong> ({score.correct}/{score.total} correct). Ready for the next set of academic words?
            </p>
          </div>
            ...
            >
              {isLoadingBatch ? (
                ...
                <>
                  ...
                  <span>Practice Next 20 Words (Set {nextSetNum})</span>
