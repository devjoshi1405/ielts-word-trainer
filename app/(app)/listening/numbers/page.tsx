...
export default function NumbersPracticePage() {
  ...
  React.useEffect(() => {
    async function load() {
      const q = await exerciseService.getQuestionsByCategory("numbers", 20);
    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in-50 duration-300">
      ...
      {!isCompleted ? (
        ...
        <Card className="text-center p-8 sm:p-12 space-y-6 border-indigo-100 dark:border-indigo-950 shadow-elevated">
          <Badge variant="success">Numbers Set Complete</Badge>
          <h2 className="text-2xl font-bold">Number Recognition Drilled</h2>
