...
import { MOCK_DASHBOARD_STATS } from "@/data/mock-stats";

export default function ProgressPage() {
  const stats = MOCK_DASHBOARD_STATS;

  const bandEstimates = [
    { accuracy: "95% - 100%", band: "Band 8.5 - 9.0", desc: "Expert user, native-level spelling & decoding" },
    { accuracy: "85% - 94%", band: "Band 7.5 - 8.0", desc: "Very good user, minor isolated spelling slips", current: true },
    { accuracy: "75% - 84%", band: "Band 6.5 - 7.0", desc: "Competent user, frequent double-letter mistakes" },
    { accuracy: "< 75%", band: "Band 5.5 - 6.0", desc: "Modest user, significant phonetic gaps" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-slate-200/80">
          <CardContent className="p-6 space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Across 32 active practice sessions
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200/80">
          <CardContent className="p-6 space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              64 of 78 flagged mistakes cleared
            </p>
          </CardContent>
        </Card>
      </div>
