        ...
        <Card className="border-slate-200/80 dark:border-slate-800 shadow-card overflow-hidden">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              >
                {isMastered ? "Topic Mastered (85%+)" : testResult.percentage >= 70 ? "Practicing (70%+)" : "Needs Practice"}
              </Badge>
            </div>

            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-slate-100">
              {topicName.toUpperCase()} TEST COMPLETE
            </h2>
          ...
          <CardContent className="p-6 sm:p-8 space-y-6">
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <Link href="/grammar">
                <Button variant="brand" size="default" className="gap-2 font-bold shadow-xs">
                  <span>Back to Grammar Master</span>
                  <ArrowRight className="w-4 h-4" />
                </Button>
              </Link>
            </div>

            {/* Mistakes Review Drawer / Section */}
